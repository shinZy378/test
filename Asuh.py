...
def login():
		try:
			...
			try:
				sy = requests.get('https://graph.facebook.com/v13.0/me?fields=profile_pic&access_token='+tokenku[0])
...
def login_lagi():
	...
	try:
		tes = requests.get('https://graph.facebook.com/v13.0/me?fields=profile_pic&access_token='+panda)
